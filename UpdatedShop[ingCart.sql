...
# Create data
INSERT INTO `customer` (`CID`, `Email`, `PhoneNumber`, `FirstName`, `Middlename`, `LastName`) VALUES
(345, 'billyjoe123@mail.com', '123456789', 'Billy', 'M', 'Joe'),
(789, 'bob@msn.com', '480-798-9009', 'Bob', 'Jim', 'Smith'),
(901, 'ChelseaY@gmail.com', '480-098-9100', 'Chelsea', '', 'Rogers');
...
INSERT INTO Orders (`CID`, `OrderID`, `Date`) VALUES
(345, 1, '2016-12-01'),
(901, 2, '2016-02-12'),
(345, 3, '2016-03-04'),
(345, 4, '2016-09-08');